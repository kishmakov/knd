...
public class KndCPostfixExpressionGImpl extends KndCPostfixExpressionImpl implements KndCPostfixExpressionG {

  public KndCPostfixExpressionGImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpressionG(this);
  }
