...
public class KndCDeclaratorImpl extends ASTWrapperPsiElement implements KndCDeclarator {

  public KndCDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDeclarator(this);
  }
