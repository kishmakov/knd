...
public class KndCDirectDeclaratorFImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorF {

  public KndCDirectDeclaratorFImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorF(this);
  }
