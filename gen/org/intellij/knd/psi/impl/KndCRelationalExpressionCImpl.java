...
public class KndCRelationalExpressionCImpl extends KndCRelationalExpressionImpl implements KndCRelationalExpressionC {

  public KndCRelationalExpressionCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCRelationalExpressionC(this);
  }
