...
public class KndCConstantImpl extends ASTWrapperPsiElement implements KndCConstant {

  public KndCConstantImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KndCEnumerationConstant getCEnumerationConstant() {
    return findChildByClass(KndCEnumerationConstant.class);
  }
