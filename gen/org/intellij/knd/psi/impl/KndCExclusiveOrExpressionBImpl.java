...
public class KndCExclusiveOrExpressionBImpl extends KndCExclusiveOrExpressionImpl implements KndCExclusiveOrExpressionB {

  public KndCExclusiveOrExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCExclusiveOrExpressionB(this);
  }
