...
public abstract class KndCBlockItemListImpl extends ASTWrapperPsiElement implements KndCBlockItemList {

  public KndCBlockItemListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCBlockItemList(this);
  }
