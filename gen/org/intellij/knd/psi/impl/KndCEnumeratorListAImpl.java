...
public class KndCEnumeratorListAImpl extends KndCEnumeratorListImpl implements KndCEnumeratorListA {

  public KndCEnumeratorListAImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KndCEnumeratorList getCEnumeratorList() {
    return findNotNullChildByClass(KndCEnumeratorList.class);
  }
