...
public class KndCShiftExpressionBImpl extends KndCShiftExpressionImpl implements KndCShiftExpressionB {

  public KndCShiftExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCShiftExpressionB(this);
  }
