...
public class KndCPostfixExpressionBImpl extends KndCPostfixExpressionImpl implements KndCPostfixExpressionB {

  public KndCPostfixExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpressionB(this);
  }
