...
public abstract class KndCPostfixExpressionImpl extends ASTWrapperPsiElement implements KndCPostfixExpression {

  public KndCPostfixExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpression(this);
  }
