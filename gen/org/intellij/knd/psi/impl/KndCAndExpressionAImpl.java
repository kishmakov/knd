...
public class KndCAndExpressionAImpl extends KndCAndExpressionImpl implements KndCAndExpressionA {

  public KndCAndExpressionAImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCAndExpressionA(this);
  }
