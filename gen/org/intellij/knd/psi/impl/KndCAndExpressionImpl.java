...
public abstract class KndCAndExpressionImpl extends ASTWrapperPsiElement implements KndCAndExpression {

  public KndCAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCAndExpression(this);
  }
