...
public abstract class KndCExpressionImpl extends ASTWrapperPsiElement implements KndCExpression {

  public KndCExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCExpression(this);
  }
