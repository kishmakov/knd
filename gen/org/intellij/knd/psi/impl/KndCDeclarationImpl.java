...
public class KndCDeclarationImpl extends ASTWrapperPsiElement implements KndCDeclaration {

  public KndCDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KndCInitDeclaratorList getCInitDeclaratorList() {
    return findChildByClass(KndCInitDeclaratorList.class);
  }
