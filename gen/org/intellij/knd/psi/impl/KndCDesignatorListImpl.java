...
public abstract class KndCDesignatorListImpl extends ASTWrapperPsiElement implements KndCDesignatorList {

  public KndCDesignatorListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDesignatorList(this);
  }
