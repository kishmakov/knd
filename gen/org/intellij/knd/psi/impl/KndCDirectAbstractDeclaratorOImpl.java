...
public class KndCDirectAbstractDeclaratorOImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorO {

  public KndCDirectAbstractDeclaratorOImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorO(this);
  }
