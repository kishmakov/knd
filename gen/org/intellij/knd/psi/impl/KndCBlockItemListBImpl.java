...
public class KndCBlockItemListBImpl extends KndCBlockItemListImpl implements KndCBlockItemListB {

  public KndCBlockItemListBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCBlockItemListB(this);
  }
