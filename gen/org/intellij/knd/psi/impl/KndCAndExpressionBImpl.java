...
public class KndCAndExpressionBImpl extends KndCAndExpressionImpl implements KndCAndExpressionB {

  public KndCAndExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCAndExpressionB(this);
  }
