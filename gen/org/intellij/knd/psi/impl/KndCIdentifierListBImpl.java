...
public class KndCIdentifierListBImpl extends KndCIdentifierListImpl implements KndCIdentifierListB {

  public KndCIdentifierListBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCIdentifierListB(this);
  }
