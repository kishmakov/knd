...
public abstract class KndCTypeQualifierListImpl extends ASTWrapperPsiElement implements KndCTypeQualifierList {

  public KndCTypeQualifierListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCTypeQualifierList(this);
  }
