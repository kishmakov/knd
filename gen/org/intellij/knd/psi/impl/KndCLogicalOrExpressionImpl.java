...
public abstract class KndCLogicalOrExpressionImpl extends ASTWrapperPsiElement implements KndCLogicalOrExpression {

  public KndCLogicalOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCLogicalOrExpression(this);
  }
