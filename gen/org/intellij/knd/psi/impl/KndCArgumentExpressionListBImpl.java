...
public class KndCArgumentExpressionListBImpl extends KndCArgumentExpressionListImpl implements KndCArgumentExpressionListB {

  public KndCArgumentExpressionListBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCArgumentExpressionListB(this);
  }
