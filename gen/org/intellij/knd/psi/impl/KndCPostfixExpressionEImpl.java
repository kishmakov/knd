...
public class KndCPostfixExpressionEImpl extends KndCPostfixExpressionImpl implements KndCPostfixExpressionE {

  public KndCPostfixExpressionEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpressionE(this);
  }
