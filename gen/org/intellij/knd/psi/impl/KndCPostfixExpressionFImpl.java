...
public class KndCPostfixExpressionFImpl extends KndCPostfixExpressionImpl implements KndCPostfixExpressionF {

  public KndCPostfixExpressionFImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpressionF(this);
  }
