...
public class KndCLabeledStatementImpl extends ASTWrapperPsiElement implements KndCLabeledStatement {

  public KndCLabeledStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCLabeledStatement(this);
  }
