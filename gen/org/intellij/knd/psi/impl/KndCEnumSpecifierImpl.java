...
public class KndCEnumSpecifierImpl extends ASTWrapperPsiElement implements KndCEnumSpecifier {

  public KndCEnumSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KndCEnumeratorList getCEnumeratorList() {
    return findChildByClass(KndCEnumeratorList.class);
  }
