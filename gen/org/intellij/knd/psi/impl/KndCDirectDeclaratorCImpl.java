...
public class KndCDirectDeclaratorCImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorC {

  public KndCDirectDeclaratorCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorC(this);
  }
