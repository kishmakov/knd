...
public class KndCDirectAbstractDeclaratorBImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorB {

  public KndCDirectAbstractDeclaratorBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorB(this);
  }
