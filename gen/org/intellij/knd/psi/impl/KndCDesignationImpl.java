...
public class KndCDesignationImpl extends ASTWrapperPsiElement implements KndCDesignation {

  public KndCDesignationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDesignation(this);
  }
