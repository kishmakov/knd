...
public class KndCRelationalExpressionEImpl extends KndCRelationalExpressionImpl implements KndCRelationalExpressionE {

  public KndCRelationalExpressionEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCRelationalExpressionE(this);
  }
