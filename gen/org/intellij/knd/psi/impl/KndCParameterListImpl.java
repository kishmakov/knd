...
public abstract class KndCParameterListImpl extends ASTWrapperPsiElement implements KndCParameterList {

  public KndCParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCParameterList(this);
  }
