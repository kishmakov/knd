...
public class KndCDirectAbstractDeclaratorRImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorR {

  public KndCDirectAbstractDeclaratorRImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorR(this);
  }
