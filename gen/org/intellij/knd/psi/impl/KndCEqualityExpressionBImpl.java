...
public class KndCEqualityExpressionBImpl extends KndCEqualityExpressionImpl implements KndCEqualityExpressionB {

  public KndCEqualityExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCEqualityExpressionB(this);
  }
