...
public class KndCDirectAbstractDeclaratorAImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorA {

  public KndCDirectAbstractDeclaratorAImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorA(this);
  }
