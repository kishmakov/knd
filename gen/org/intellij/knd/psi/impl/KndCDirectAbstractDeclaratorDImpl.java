...
public class KndCDirectAbstractDeclaratorDImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorD {

  public KndCDirectAbstractDeclaratorDImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorD(this);
  }
