...
public class KndCShiftExpressionCImpl extends KndCShiftExpressionImpl implements KndCShiftExpressionC {

  public KndCShiftExpressionCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCShiftExpressionC(this);
  }
