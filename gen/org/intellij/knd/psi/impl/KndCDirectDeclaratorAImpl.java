...
public class KndCDirectDeclaratorAImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorA {

  public KndCDirectDeclaratorAImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorA(this);
  }
