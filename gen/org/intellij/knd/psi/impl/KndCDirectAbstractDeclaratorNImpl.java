...
public class KndCDirectAbstractDeclaratorNImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorN {

  public KndCDirectAbstractDeclaratorNImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorN(this);
  }
