...
public class KndCInitializerListDImpl extends KndCInitializerListImpl implements KndCInitializerListD {

  public KndCInitializerListDImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCInitializerListD(this);
  }
