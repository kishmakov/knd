...
public class KndCEnumerationConstantImpl extends ASTWrapperPsiElement implements KndCEnumerationConstant {

  public KndCEnumerationConstantImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCEnumerationConstant(this);
  }
