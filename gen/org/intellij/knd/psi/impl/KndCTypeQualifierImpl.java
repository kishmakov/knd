...
public class KndCTypeQualifierImpl extends ASTWrapperPsiElement implements KndCTypeQualifier {

  public KndCTypeQualifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCTypeQualifier(this);
  }
