...
public class KndCCompoundStatementImpl extends ASTWrapperPsiElement implements KndCCompoundStatement {

  public KndCCompoundStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCCompoundStatement(this);
  }
  ...
  public KndCBlockItemList getCBlockItemList() {
    return findChildByClass(KndCBlockItemList.class);
  }
