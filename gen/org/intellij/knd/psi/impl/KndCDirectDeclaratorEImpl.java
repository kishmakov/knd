...
public class KndCDirectDeclaratorEImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorE {

  public KndCDirectDeclaratorEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorE(this);
  }
