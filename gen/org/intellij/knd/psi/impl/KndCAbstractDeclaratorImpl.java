...
public class KndCAbstractDeclaratorImpl extends ASTWrapperPsiElement implements KndCAbstractDeclarator {

  public KndCAbstractDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KndCDirectAbstractDeclarator getCDirectAbstractDeclarator() {
    return findChildByClass(KndCDirectAbstractDeclarator.class);
  }
