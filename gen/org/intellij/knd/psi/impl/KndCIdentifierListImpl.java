...
public abstract class KndCIdentifierListImpl extends ASTWrapperPsiElement implements KndCIdentifierList {

  public KndCIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCIdentifierList(this);
  }
