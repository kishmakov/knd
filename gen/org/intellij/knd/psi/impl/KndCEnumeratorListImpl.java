...
public abstract class KndCEnumeratorListImpl extends ASTWrapperPsiElement implements KndCEnumeratorList {

  public KndCEnumeratorListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCEnumeratorList(this);
  }
