...
public class KndCFunctionSpecifierImpl extends ASTWrapperPsiElement implements KndCFunctionSpecifier {

  public KndCFunctionSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCFunctionSpecifier(this);
  }
