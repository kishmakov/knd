...
public class KndCDirectDeclaratorGImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorG {

  public KndCDirectDeclaratorGImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorG(this);
  }
