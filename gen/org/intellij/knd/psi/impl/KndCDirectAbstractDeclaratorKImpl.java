...
public class KndCDirectAbstractDeclaratorKImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorK {

  public KndCDirectAbstractDeclaratorKImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KndCAbstractDeclarator getCAbstractDeclarator() {
    return findNotNullChildByClass(KndCAbstractDeclarator.class);
  }
