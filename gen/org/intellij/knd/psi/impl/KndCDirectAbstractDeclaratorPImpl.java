...
public class KndCDirectAbstractDeclaratorPImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorP {

  public KndCDirectAbstractDeclaratorPImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorP(this);
  }
