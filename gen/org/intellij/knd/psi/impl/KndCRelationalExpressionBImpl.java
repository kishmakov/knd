...
public class KndCRelationalExpressionBImpl extends KndCRelationalExpressionImpl implements KndCRelationalExpressionB {

  public KndCRelationalExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCRelationalExpressionB(this);
  }
