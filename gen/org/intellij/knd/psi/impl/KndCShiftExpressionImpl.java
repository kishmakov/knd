...
public abstract class KndCShiftExpressionImpl extends ASTWrapperPsiElement implements KndCShiftExpression {

  public KndCShiftExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCShiftExpression(this);
  }
