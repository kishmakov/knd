...
public class KndCDirectAbstractDeclaratorSImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorS {

  public KndCDirectAbstractDeclaratorSImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorS(this);
  }
