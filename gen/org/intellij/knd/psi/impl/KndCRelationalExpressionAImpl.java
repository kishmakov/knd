...
public class KndCRelationalExpressionAImpl extends KndCRelationalExpressionImpl implements KndCRelationalExpressionA {

  public KndCRelationalExpressionAImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCRelationalExpressionA(this);
  }
