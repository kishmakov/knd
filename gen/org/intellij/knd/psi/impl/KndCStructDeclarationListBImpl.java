...
public class KndCStructDeclarationListBImpl extends KndCStructDeclarationListImpl implements KndCStructDeclarationListB {

  public KndCStructDeclarationListBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCStructDeclarationListB(this);
  }
