...
public class KndCArgumentExpressionListAImpl extends KndCArgumentExpressionListImpl implements KndCArgumentExpressionListA {

  public KndCArgumentExpressionListAImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KndCArgumentExpressionList getCArgumentExpressionList() {
    return findNotNullChildByClass(KndCArgumentExpressionList.class);
  }
