...
public class KndCDeclarationListBImpl extends KndCDeclarationListImpl implements KndCDeclarationListB {

  public KndCDeclarationListBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDeclarationListB(this);
  }
