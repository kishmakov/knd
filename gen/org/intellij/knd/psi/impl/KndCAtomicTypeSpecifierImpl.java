...
public class KndCAtomicTypeSpecifierImpl extends ASTWrapperPsiElement implements KndCAtomicTypeSpecifier {

  public KndCAtomicTypeSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCAtomicTypeSpecifier(this);
  }
