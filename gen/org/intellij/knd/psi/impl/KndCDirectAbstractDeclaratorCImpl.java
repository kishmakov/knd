...
public class KndCDirectAbstractDeclaratorCImpl extends KndCDirectAbstractDeclaratorImpl implements KndCDirectAbstractDeclaratorC {

  public KndCDirectAbstractDeclaratorCImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectAbstractDeclaratorC(this);
  }
