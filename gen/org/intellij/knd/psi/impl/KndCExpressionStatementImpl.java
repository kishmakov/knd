...
public class KndCExpressionStatementImpl extends ASTWrapperPsiElement implements KndCExpressionStatement {

  public KndCExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCExpressionStatement(this);
  }
