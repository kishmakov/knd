...
public class KndCExpressionBImpl extends KndCExpressionImpl implements KndCExpressionB {

  public KndCExpressionBImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCExpressionB(this);
  }
