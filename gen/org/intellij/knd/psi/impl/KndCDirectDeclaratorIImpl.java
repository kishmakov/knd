...
public class KndCDirectDeclaratorIImpl extends KndCDirectDeclaratorImpl implements KndCDirectDeclaratorI {

  public KndCDirectDeclaratorIImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCDirectDeclaratorI(this);
  }
