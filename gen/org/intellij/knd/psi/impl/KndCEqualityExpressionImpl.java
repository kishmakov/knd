...
public abstract class KndCEqualityExpressionImpl extends ASTWrapperPsiElement implements KndCEqualityExpression {

  public KndCEqualityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCEqualityExpression(this);
  }
