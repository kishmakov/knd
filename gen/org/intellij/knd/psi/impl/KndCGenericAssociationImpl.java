...
public class KndCGenericAssociationImpl extends ASTWrapperPsiElement implements KndCGenericAssociation {

  public KndCGenericAssociationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCGenericAssociation(this);
  }
