...
public class KndCAssignmentOperatorImpl extends ASTWrapperPsiElement implements KndCAssignmentOperator {

  public KndCAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCAssignmentOperator(this);
  }
