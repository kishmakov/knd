...
public class KndCPostfixExpressionHImpl extends KndCPostfixExpressionImpl implements KndCPostfixExpressionH {

  public KndCPostfixExpressionHImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCPostfixExpressionH(this);
  }
