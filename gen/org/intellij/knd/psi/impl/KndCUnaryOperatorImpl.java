...
public class KndCUnaryOperatorImpl extends ASTWrapperPsiElement implements KndCUnaryOperator {

  public KndCUnaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KndVisitor visitor) {
    visitor.visitCUnaryOperator(this);
  }
